...
export async function PUT(request: NextRequest, { params }: RouteParams) {
  ...
  if (!Array.isArray(symlinkPaths) || !symlinkPaths.every((p: unknown) => typeof p === "string")) {
    return NextResponse.json({ error: "symlinkPaths must be an array of strings" }, { status: 400 })
  }
