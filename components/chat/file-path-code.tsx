...
const FILE_EXTENSIONS = new Set([
  ...
  ".md", ".mdx", ".py", ".rs", ".go", ".rb", ".java", ".kt",
  ".yaml", ".yml", ".toml", ".xml", ".svg",
  ".sh", ".bash", ".zsh", ".fish",
  ".sql", ".graphql", ".gql",
  ".dockerfile", ".env", ".gitignore",
  ".c", ".cpp", ".h", ".hpp",
  ".swift", ".lua", ".php", ".r", ".vue", ".svelte",
  ".lock", ".config", ".txt", ".log", ".csv",
])
...
const KNOWN_FILENAMES = new Set([
  ...
  "rakefile", "cmakelists.txt", "cargo.toml",
...
export function FilePathCode({ children, text }: FilePathCodeProps) {
  ...
  return (
    <a
      href={href}
      className={cn(
        "rounded bg-muted px-1.5 py-0.5 text-sm font-mono no-underline",
