...
function ProcessRow({ process, maxCpu }: ProcessRowProps) {
  ...
  return (
    <div className="grid grid-cols-[1fr_auto_auto_auto] gap-2 items-center text-xs py-1.5 border-b border-border/50 last:border-0">
      <div className="min-w-0">
        <p className={cn("font-medium truncate", isHighCpu && "text-yellow-500")}>
          {process.name}
        </p>
      ...
      <div className="text-right w-14 text-muted-foreground font-mono">
  ...
  return (
    <Card>
      <CardHeader className="pb-2">
        ...
        <div className="grid grid-cols-[1fr_auto_auto_auto] gap-2 text-xs text-muted-foreground mt-1">
          <span>Name</span>
