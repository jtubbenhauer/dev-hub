...
export function useLeaderKey() {
  ...
  if (!context)
    throw new Error("useLeaderKey must be used within LeaderKeyProvider");
  return context;
}
...
export function LeaderKeyProvider({
  ...
  timeoutMs = DEFAULT_LEADER_TIMEOUT_MS,
