...
function applyThemeClasses(theme: AppTheme) {
  ...
  switch (theme) {
    case "catppuccin-mocha":
      root.classList.add("dark", "catppuccin-mocha");
      break;
    case "catppuccin-macchiato":
      root.classList.add("dark", "catppuccin-macchiato");
      break;
    case "catppuccin-frappe":
      root.classList.add("dark", "catppuccin-frappe");
      break;
    case "catppuccin-latte":
      root.classList.add("light", "catppuccin-latte");
      break;
    case "dracula":
      root.classList.add("dark", "dracula");
      break;
    case "github-dark":
      root.classList.add("dark", "github-dark");
      break;
    case "default-dark":
