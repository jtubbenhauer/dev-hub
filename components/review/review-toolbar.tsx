...
import { RefreshCw, ArrowLeft, Loader2, PanelLeft } from "lucide-react";
...
export function ReviewToolbar({
  ...
  const isComplete =
    review.totalFiles > 0 && review.reviewedFiles === review.totalFiles;
    ...
    <div className="flex shrink-0 items-center gap-2 border-b px-2 py-2 md:gap-3 md:px-3">
      ...
      <div className="ml-auto flex items-center gap-2 md:gap-3">
        <div className="flex items-center gap-1.5 md:gap-2">
          ...
          <div className="bg-muted h-1.5 w-12 rounded-full md:w-20">
            <div
