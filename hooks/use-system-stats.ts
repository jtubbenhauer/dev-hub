...
async function fetchSystemStats(history: boolean): Promise<SystemStats | SystemStatsWithHistory> {
...
export function useSystemStatsSnapshot(options: Omit<UseSystemStatsOptions, "history"> = {}) {
...
export function useSystemStatsWithHistory(options: Omit<UseSystemStatsOptions, "history"> = {}) {
