import { Workspace, ProviderBehaviour, DEFAULT_PROVIDER_BEHAVIOUR } from "@/types"
...
export function getWorkspaceBehaviour(workspace: Workspace): ProviderBehaviour {
  ...
  return { ...DEFAULT_PROVIDER_BEHAVIOUR, ...(meta.behaviour as Partial<ProviderBehaviour>) }
}

export function shouldSSEConnect(workspace: Workspace, activeWorkspaceId: string | null): boolean {
