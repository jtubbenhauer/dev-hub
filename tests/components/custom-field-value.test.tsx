...
describe("CustomFieldValue", () => {
  describe("percentage / progress fields", () => {
    it("renders percent_completed as percentage", () => {
      render(
        <CustomFieldValue
          field={field({ type: "automatic_progress", value: { current: "95", percent_completed: 0.95 } })}
        />
      )
    ...
    it("renders 0% for percent_completed of 0", () => {
      render(
        <CustomFieldValue
          field={field({ type: "manual_progress", value: { current: "0", percent_completed: 0 } })}
        />
      )
    ...
    it("falls back to current when percent_completed is missing", () => {
      render(
        <CustomFieldValue
          field={field({ type: "automatic_progress", value: { current: "50", percent_completed: undefined } })}
        />
      )
    ...
    it("renders 100% for fully complete", () => {
      render(
        <CustomFieldValue
          field={field({ type: "manual_progress", value: { current: "100", percent_completed: 1 } })}
        />
      )
    ...
    it("rounds fractional percentages", () => {
      render(
        <CustomFieldValue
          field={field({ type: "automatic_progress", value: { current: "33", percent_completed: 0.3333 } })}
        />
      )
  ...
  describe("default fallback", () => {
    it("renders string values without JSON quotes", () => {
      render(<CustomFieldValue field={field({ type: "unknown_type", value: "505" })} />)
    ...
    it("renders non-string values as JSON", () => {
      render(<CustomFieldValue field={field({ type: "unknown_type", value: { foo: "bar" } })} />)
