...
vi.mock("@/lib/sounds", () => ({
  SOUND_OPTIONS: [
    { id: "alert-01", label: "Alert 1", category: "alerts", filename: "alert-01.aac" },
    { id: "bip-bop-01", label: "Bip Bop 1", category: "bip-bops", filename: "bip-bop-01.aac" },
    { id: "staplebops-01", label: "Staplebops 1", category: "staplebops", filename: "staplebops-01.aac" },
    { id: "nope-01", label: "Nope 1", category: "nopes", filename: "nope-01.aac" },
...
describe("SoundSettingsCard", () => {
  ...
  it("renders description text", () => {
    render(<SoundSettingsCard />)
    expect(screen.getByText("Configure notification sounds for different events.")).toBeInTheDocument()
  })
  ...
  it("renders row descriptions", () => {
    render(<SoundSettingsCard />)
    expect(screen.getByText("Play sound when the agent completes or needs attention")).toBeInTheDocument()
    expect(screen.getByText("Play sound when a permission is required")).toBeInTheDocument()
